...
return [
    ...
    'attention_title'   => 'Perlu perhatian',
    'attention_sub'     => 'Yang sebaiknya dibereskan sebelum klien menyadarinya',
    'attention_none'    => 'Tidak ada yang perlu ditangani sekarang.',
    'att_over_budget'   => ':count key melewati batas biayanya|:count key melewati batas biayanya',
    'att_near_budget'   => ':count key mendekati batas biayanya|:count key mendekati batas biayanya',
    'att_expiring'      => ':count key kedaluwarsa dalam 14 hari|:count key kedaluwarsa dalam 14 hari',
    'att_expiring_one'  => '":name" kedaluwarsa :when',
    'att_disabled'      => ':count key sedang dinonaktifkan|:count key sedang dinonaktifkan',
    'att_no_key'        => ':count perusahaan aktif belum punya API key|:count perusahaan aktif belum punya API key',
    'att_never_pulled'  => ':count key belum pernah ditarik datanya|:count key belum pernah ditarik datanya',
    'att_stale'         => 'Data pemakaian terakhir ditarik :when',
    'att_fix'           => 'Buka',

    'client_title'      => 'Laporan klien',
    'client_sub'        => 'Link yang dibagikan, 7 hari terakhir',
    'client_links'      => 'Link aktif',
    'client_opens'      => 'Dibuka',
    'client_readers'    => 'Pembaca',
    'client_last'       => 'Terakhir dibuka :when',
    'client_never'      => 'Belum ada yang membuka',
    'client_none'       => 'Belum ada link laporan yang dibagikan.',
    'client_manage'     => 'Perusahaan',
    'per_day'  => 'req/hari',
    'peak_day' => 'Tertinggi :day · :count',
];
