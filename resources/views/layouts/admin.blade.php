...
<head>
    ...
    <style>
        ...
        .admin-navbar .navbar-brand img { height: 26px; }
        ...
        .nav-right .nav-icon:hover { background: #f0f2f5; color: #1a1a2e; }
        ...
        .nav-link-admin:hover { color: #fff; background: rgba(255, 255, 255, 0.1); }
        .nav-link-admin.active { color: #fff; background: rgba(255, 255, 255, 0.2); font-weight: 500; }
        ...
        .btn-grab:hover { background: var(--grab-green-dark); color: #fff; }
        ...
        .btn-outline-grab:hover { background: var(--grab-green-light); color: var(--grab-green-dark); }
        ...
        .page-header h4, .page-header small, .page-header a { color: #fff; }
        ...
        .content-area { margin-top: -1.5rem; position: relative; z-index: 2; }

        /* Chart bar */
        .chart-bar { display: flex; align-items: flex-end; gap: 2px; height: 200px; }
        .chart-bar .bar-wrapper { flex: 1; height: 100%; display: flex; align-items: flex-end; position: relative; }
        .chart-bar .bar {
            width: 100%;
        ...
        .chart-bar .bar:hover .bar-tooltip { opacity: 1; visibility: visible; transform: translateX(-50%) translateY(-4px); }
        .bar-tooltip {
            opacity: 0;
            visibility: hidden;
            position: absolute;
        ...
        .op-bar-track { flex: 1; height: 8px; background: #f0f2f5; border-radius: 4px; overflow: hidden; }
        .op-bar-fill {
            height: 100%;
        ...
        .empty-state i { font-size: 2.5rem; color: #ced4da; margin-bottom: 12px; }

        /* Modal */
        .modal-content { border: none; border-radius: 16px; }
        .modal .form-select, .modal .form-control { border-radius: 10px; border-color: #e2e8f0; }
...
<body>
    ...
    <nav class="admin-navbar">
        <div class="container">
            <a class="navbar-brand" href="{{ route('admin.companies.index') }}">
                <img src="{{ asset('logo2.png') }}" alt="Grab">
                <span class="brand-text">GrabMaps</span>
            ...
            <div class="nav-right">
                <a href="{{ url('/') }}" class="nav-icon" title="Lihat Homepage" target="_blank">
