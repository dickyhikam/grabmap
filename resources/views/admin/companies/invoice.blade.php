    ...
    <div class="sheet">
        ...
        <div class="meta">
            ...
            <div class="block" style="text-align:right;">
                ...
                <div class="v">{{ \Carbon\Carbon::parse($startDate)->wib()->format('d M Y') }} – {{ \Carbon\Carbon::parse($endDate)->wib()->format('d M Y') }}</div>
                <div class="muted">Issued: {{ $issuedAt->wib()->format('d M Y') }}</div>
                @if($fetchedAt)<div class="muted">Data as of: {{ $fetchedAt->wib()->format('d M Y H:i') }} WIB</div>@endif
            </div>
        </div>
        ...
        <div class="kurs">
            ...
            <table>
                ...
                @if(!empty($activeRate))
                    ...
                    <tr><td>Rate date</td><td>{{ $activeRate->rate_date->wib()->format('d M Y') }}</td></tr>
        ...
        <div class="foot">
            <span>Generated by {{ config('app.name', 'GrabMaps') }} — {{ $issuedAt->wib()->format('d M Y H:i') }} WIB</span>
            <span>{{ $invoiceNo }}</span>
        </div>
    </div>
