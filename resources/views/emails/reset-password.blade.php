...
<head>
    ...
    <style>
        @media only screen and (max-width: 600px) {
            ...
            .email-header { padding: 32px 22px 28px !important; }
        ...
        <tr>
            <td align="center" style="padding:40px 16px;">
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" class="email-container" style="max-width:600px;width:100%;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 10px 40px rgba(0,0,0,0.08);">
                    ...
                    <!-- HEADER -->
                    <tr>
                        <td class="email-header" style="background:linear-gradient(135deg,#00B14F 0%,#008b3d 100%);padding:42px 36px 36px;text-align:center;">
                            ...
                            <h1 style="color:#ffffff;margin:0;font-size:24px;font-weight:800;letter-spacing:-0.5px;">Reset Password</h1>
                            <p style="color:rgba(255,255,255,0.92);margin:8px 0 0;font-size:14px;">Permintaan pembuatan password baru</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="email-body" style="padding:38px 42px 36px;color:#1f2937;">
                            <p style="margin:0 0 16px;font-size:16px;line-height:1.6;">
                                Hi <b style="color:#00B14F;">{{ $userName }}</b>,
                            </p>
                            <p style="margin:0 0 22px;font-size:15px;line-height:1.65;color:#4b5563;">
                                Kami menerima permintaan untuk mereset password akun Grab Maps kamu (<b>{{ $userEmail }}</b>).
                            ...
                            <!-- Expiry note -->
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#fffbeb;border:1px solid #fde68a;border-radius:12px;margin-bottom:22px;">
                                <tr>
                                    <td style="padding:14px 18px;font-size:13px;color:#92400e;line-height:1.5;">
                                        ⏱️ Tautan ini berlaku selama <b>{{ $expire }} menit</b>. Setelah itu kamu perlu meminta tautan baru.
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="margin:0 0 8px;font-size:13px;color:#6b7280;">
                                Jika tombol tidak berfungsi, salin dan buka URL ini di browser:
                            </p>
                                ...
                                <tr>
                                    <td style="border-top:1px solid #e5e7eb;padding-top:18px;">
                                        <p style="margin:0;font-size:12px;color:#9ca3af;line-height:1.6;">
                                            <b style="color:#6b7280;">Tidak meminta ini?</b> Abaikan email ini — password kamu tidak akan berubah selama tautan di atas tidak dibuka.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="background:#f9fafb;padding:24px 36px;text-align:center;border-top:1px solid #e5e7eb;">
                            <p style="margin:0 0 6px;font-size:13px;color:#6b7280;font-weight:600;">Grab Maps Admin</p>
                            <p style="margin:0;font-size:11px;color:#9ca3af;line-height:1.5;">
                                Powered by AWS Location Service · GrabMaps Southeast Asia
                            </p>
                            <p style="margin:10px 0 0;font-size:10px;color:#d1d5db;">
                                © {{ date('Y') }} Grab. Pesan otomatis — mohon jangan dibalas.
                            </p>
                        </td>
                    </tr>
                </table>
